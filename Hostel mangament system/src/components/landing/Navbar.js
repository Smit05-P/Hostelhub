      ...
      <div className="max-w-[1440px] mx-auto px-6 h-full flex items-center justify-between">
        ...
        <div className="flex items-center gap-2 md:gap-4">
          <div className="hidden lg:flex items-center gap-4">
            <Link 
              href="/login" 
              className="text-[15px] text-slate-600 hover:text-[#6366f1] transition-all font-semibold h-[44px] flex items-center px-4 hover:-translate-y-0.5"
            >
              Sign In
            </Link>
            <Link 
        ...
        <div className="fixed inset-0 z-[200] bg-white flex flex-col p-6 animate-in fade-in slide-in-from-right duration-500">
          ...
          <div className="flex flex-col items-center gap-8 mt-12">
            ...
            <Link 
              href="/login"
              onClick={() => setMobileMenuOpen(false)}
              className="text-[24px] font-bold text-slate-500 tracking-tight mt-4"
            >
              Sign In
            </Link>
          </div>
